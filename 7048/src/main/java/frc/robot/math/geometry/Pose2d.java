 ...
 * New robot poses can then calculated moving along a straight line (translation) or circle (twist).
 * It's the <i>physicsy nougat</i> maths you need to track the robot!
 *
 * <p><a href="https://mathbitsnotebook.com/Geometry/Transformations/TRRigidTransformations.html">See more</a>
 *
 * <p><b>Exp:</b> Move the robot <b>along a circle</b> for a duration of time
 * <p><b>Intersection:</b> <b>Project</b> the two RigidTransform2d and <b>find where they meet</b>
 * <p><b>Interpolate:</b> Add the <b>scaled difference</b> of these RigidTransform2d <b>along a circle</b>, <b>bounded</b> by the two RigidTransform2d
 * <p><b>IsColinear:</b> Are the headings <b>on the same line?</b>
 * <p><b>Log:</b> <b>Find the relative path</b> a robot took along a circle to reach this location + orientation
 * <p><b>TransformBy:</b> Move the robot along a straight line <b>and/or</b> change orientation
 *
 * <p>Represents a 2d pose (rigid transform) containing translational and rotational elements.
 *
