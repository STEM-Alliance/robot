...
import static frc.robot.math.geometry.Util.epsilonEquals;

/**
 * Two {@link MotionState}s that define a piece of a path between two waypoints with constant acceleration
 *
 * <p>A MotionSegment is a movement from a start MotionState to an end MotionState with a constant acceleration.
