...
import frc.robot.math.motion.MotionProfileGoal.CompletionBehavior;

/**
 * Controller to follow a {@link MotionProfile} path, does not handle heading correction.
 *
 * <p>A controller for tracking a profile generated to attain a MotionProfileGoal. The controller uses feedforward on
