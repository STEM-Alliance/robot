...
/**
 * Rebuilds a {@link MotionProfile} path "on the fly" so that the robot can adjust.
 *
 * <p>Note: This is a big reason why it is preferable to calculate paths on the robot.
 *
 * <p>A SetpointGenerate does just-in-time motion profile generation to supply a stream of setpoints that obey the given
