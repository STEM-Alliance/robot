...
{
    public static HerdVector NEUTRAL = new HerdVector(0, 0);
    ...
    public double getX()
    {
        return mag * Math.sin(angle);  // Positive y-axis as zero angle
    }

    public double getY()
    {
        return mag * Math.cos(angle);  // Positive y-axis as zero angle
    }
