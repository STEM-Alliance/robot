...
import frc.robot.config.TalonConfig.FollowerConfig;
import frc.robot.config.TalonConfig.Gains;
import frc.robot.config.TalonConfig.MasterConfig;
import frc.robot.hardware.LazyTalon;
...
/**
 * Configures all of the WPI_TalonSRX's
...
public final class TalonFactory
{
    ...
    public static void configCurrentLimiting(WPI_TalonSRX t, int continuousAmps)
    {
    ...
    public static void configCurrentLimiting(WPI_TalonSRX t, int continuousAmps, int peakAmps, int peakMs)
    {
    ...
    public static void configFastErrorReporting(WPI_TalonSRX t, boolean enable)
    {
    ...
    public static void configOpenLoopOnly(WPI_TalonSRX t)
    {
    ...
    public static List<WPI_TalonSRX> makeClosedLoopTalon(ClosedLoopConfig config)
    {
        List<WPI_TalonSRX> talons = new ArrayList<WPI_TalonSRX>();
        ...
        {
            WPI_TalonSRX t = makeTalon(m.kAddress);
     ...
     * @return
     */
    public static WPI_TalonSRX makeFollowerTalon(int address, BaseMotorController master)
    {
        WPI_TalonSRX t = makeTalon(address);
     ...
     */
    public static WPI_TalonSRX makeTalon(int address)
    {
        WPI_TalonSRX t = new LazyTalon(address);
        configDefaults(t);
        return t;
    }
    ...
    private static void configDefaults(BaseMotorController t)
    {
        ...
        if (t instanceof WPI_TalonSRX)
        {
            WPI_TalonSRX talon = (WPI_TalonSRX) t;
    ...
    private static void configEncoder(WPI_TalonSRX t)
    {
    ...
    private static void configPIDF(WPI_TalonSRX t, Gains config)
    {
