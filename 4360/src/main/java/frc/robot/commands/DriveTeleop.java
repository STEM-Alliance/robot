...
public final class DriveTeleop extends CommandBase
{
    ...
    public void execute()
    {
      if(todd == 1){
        ...
        drive.robotDrive.arcadeDrive(OI.xbox.getRawAxis(4)  , OI.xbox.getRawAxis(1)*1 , true);
      }
      if(todd == -1){
     
        drive.robotDrive.arcadeDrive(OI.xbox.getRawAxis(4)*0.6  , OI.xbox.getRawAxis(1)*0.6 , true);
      }
