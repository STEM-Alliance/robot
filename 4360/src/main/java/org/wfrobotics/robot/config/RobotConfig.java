...
public class RobotConfig extends EnhancedRobotConfig
{
    ...
    public TankConfig getTankConfig()
    {
        ...
        config.CLOSED_LOOP = new ClosedLoopConfig("Tank", new MasterConfig[] {
            ...
            new MasterConfig(14, false, false, new FollowerConfig(15, true), new FollowerConfig(13, false)),
            
            new MasterConfig(11, true, false, new FollowerConfig(10, true), new FollowerConfig(12, false)),
        }, new Gains[] {
