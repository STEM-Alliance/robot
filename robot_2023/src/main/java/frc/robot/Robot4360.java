...
public class Robot4360 extends TimedRobot {
    ...
    ElevatorSubsystemMoorhead m_elevatorSubsystem = new ElevatorSubsystemMoorhead(7, 6);
    ...
    public void robotInit() {
        ...
        //m_gripperDrive = new RunCommand(() -> m_gripper.slideGripper(m_controller2.getLeftX(), m_controller2.getRightX()), m_gripper);
        m_elevatorCommand = new RunCommand(() -> m_elevatorSubsystem.control(m_controller2.getLeftY(), m_controller2.getRightY()));
