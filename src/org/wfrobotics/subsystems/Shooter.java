...
public class Shooter extends Subsystem 
{
    ...
    private final double TOP_P = 0.045;
    private final double TOP_I = 0.0000;
    private final double TOP_D = 0.0000;
    
    // 100% of total feed forward / native counts per 100ms @ 4000rpm
    private final double TOP_F = 0.027;//1.0 * 1023 / ( 4000 * (1/60) * (1/10) * 4096);
    private final double TOP_RAMP = 0.01;

    private final double BOTTOM_P = 0.1;
