...
import org.wfrobotics.reuse.subsystems.control2018.trajectory.timing.CentripetalAccelerationConstraint;
...
{
    private static final double kMultiplierDebugging = 13.0/17.0;
    private static final double kMaxVelocity = kMultiplierDebugging * 120.0;  // TODO was 130.0
    private static final double kMaxAccel = kMultiplierDebugging * 120.0;  // TODO was 130.0
    private static final double kMaxCentripetalAccelElevatorDown = kMultiplierDebugging * 100.0;  // TODO was 110.0
    private static final double kMaxCentripetalAccel = kMultiplierDebugging * 90.0;  // TODO was 100.0
    private static final double kMaxVoltage = 11.0; // TODO was 9.0
    private static final double kFirstPathMaxVoltage = 11.0; // TODO was 9.0
    private static final double kFirstPathMaxAccel = kMultiplierDebugging * 120.0;  // TODO was 130.0
    private static final double kFirstPathMaxVel = kMultiplierDebugging * 120.0;  // TODO was 130.0

    private static final double kSimpleSwitchMaxAccel = kMultiplierDebugging * 90.0;  // TODO was 100
    private static final double kSimpleSwitchMaxCentripetalAccel = kMultiplierDebugging * 70.0;  // TODO was 80
    private static final double kSimpleSwitchMaxVelocity = kMultiplierDebugging * 110.0;  // TODO was 120
    ...
    public class TrajectorySet {
        public class MirroredTrajectory {
            public MirroredTrajectory(Trajectory<TimedState<Pose2dWithCurvature>> right) {
                this.right = right;
                left = TrajectoryUtil.mirrorTimed(right);
            }
        ...
        public final MirroredTrajectory tuning;
        ...
        private TrajectorySet() {
            ...
            tuning = new MirroredTrajectory(getTuning());
        }
        ...
        private Trajectory<TimedState<Pose2dWithCurvature>> getTuning() {
            List<Pose2d> waypoints = new ArrayList<>();
            waypoints.add(new Pose2d(new Translation2d(0.0, 0.0), Rotation2d.fromDegrees(0.0)));
            waypoints.add(new Pose2d(new Translation2d(3.0 * 12.0, 0.0), Rotation2d.fromDegrees(0.0)));
