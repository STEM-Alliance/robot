...
public class IO
{
    ...
    public static Button X = ButtonFactory.makeButton(controller, Xbox.BUTTON.X, TRIGGER.WHEN_PRESSED, new ToggleConstAccel(2));
    public static Button Y = ButtonFactory.makeButton(controller, Xbox.BUTTON.Y, TRIGGER.WHILE_HELD, new DriveConstAccel(2));
