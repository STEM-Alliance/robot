...
public class IO
{
    ...
    public static Button X = ButtonFactory.makeButton(controller, Xbox.BUTTON.X, TRIGGER.WHEN_PRESSED, new ExampleForwardCommand());
    public static Button Y = ButtonFactory.makeButton(controller, Xbox.BUTTON.Y, TRIGGER.WHEN_PRESSED, new ExampleForwardCommand());
