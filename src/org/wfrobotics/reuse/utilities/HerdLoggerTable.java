...
/**
 * The {@link HerdLoggerTable} class is copied from {@link SmartDashboard},
 * but uses a custom table address
 */
public class HerdLoggerTable {

    /**
     * The {@link NetworkTable} used by {@link SmartDashboard}.
     */
    private static final NetworkTable table =
            NetworkTableInstance.getDefault().getTable("HerdLogger");
    ...
    /**
     * A table linking tables in the SmartDashboard to the {@link Sendable}
     ...
     * @return False if the table key exists with a different type
     */
    public static boolean setDefaultBooleanArray(String key,
     ...
     * @return False if the table key exists with a different type
     */
    public static boolean setDefaultNumberArray(String key,
            double[] defaultValue)
    {
     ...
     * @return False if the table key exists with a different type
     */
    public static boolean setDefaultStringArray(String key,
            String[] defaultValue)
    {
