...
public class ShooterSubsystem3 extends SubsystemBase {
  ...
  private static double m_unhookPosition = Configuration.kShooterSetpoints.UNHOOK.getRotationTarget();
  private static double m_autoShootingPosition = Configuration.kShooterSetpoints.AUTOSHOOT.getRotationTarget();
  private static double m_ampPosition = Configuration.kShooterSetpoints.AMP.getRotationTarget();
...
private double getArmPos() {
  ...
  public Command setSetpoint(Configuration.kShooterSetpoints setpoint) {
